    ...
    <section id="about" className="py-20 mx-auto max-w-6xl px-4 flex flex-col lg:flex-row gap-2">
      <div className='order-2 lg:order-1 flex flex-col justify-center w-full p-4 h-full rounded-md mr-16'>
        ...
        <p className="mt-4 text-base text-[#50341F]">
         Clique em “
         {whatsappLinkImposto ? (
           <a href={whatsappLinkImposto} target="_blank" rel="noopener noreferrer" className="underline hover:opacity-80">Quero ajuda para declarar meu IRPF</a>
         ) : (
           <span className="underline">Quero ajuda para declarar meu IRPF</span>
         )}
      ...
      <div className="order-1 lg:order-2 mx-auto max-w-6xl px-4">
        <img src="/assets/renata_.png" alt="" className="sm:w-full md:w-96 lg:max-w-2xs" />
      </div>
    </section>
  )
}